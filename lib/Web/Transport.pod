...
There is also the C<stream> option, which is only accepted by the
C<request> method of the L<Web::Transport::BasicClient> module.
...
and L<Web::Transport::PSGIServerConnection> require following modules
