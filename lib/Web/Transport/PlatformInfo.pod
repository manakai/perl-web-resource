...
browsers), C<tablet> (tablet browsers), or C<mobile> (smartphone
browsers).  The second argument is the OS, i.e. C<windows>, C<mac>,
C<ios>, or C<linux>.  The third argument is the navigator
compatibility mode, i.e. C<chrome>, C<webkit>, or C<gecko>.
